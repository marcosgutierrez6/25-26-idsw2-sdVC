  ...
  routes: [
    {
      ...
      children: [
        ...
        { path: 'asignaturas/nuevo', name: 'AsignaturasNuevo', component: () => import('../views/AsignaturasFormView.vue') },
        { path: 'asignaturas/:id/editar', name: 'AsignaturasEditar', component: () => import('../views/AsignaturasFormView.vue') },

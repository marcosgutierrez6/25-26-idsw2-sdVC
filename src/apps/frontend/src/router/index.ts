  ...
  routes: [
    {
      ...
      children: [
        ...
        { path: 'profesores', name: 'Profesores', component: () => import('../views/Profesores/ProfesoresView/ProfesoresView.vue') },
        { path: 'profesores/nuevo', name: 'ProfesoresNuevo', component: () => import('../views/Profesores/ProfesoresForm/ProfesoresFormView.vue') },
        { path: 'profesores/:id/editar', name: 'ProfesoresEditar', component: () => import('../views/Profesores/ProfesoresForm/ProfesoresFormView.vue') },
